<nav class="navbar navbar-light bg-white border-bottom navbar-expand">
    <div class="container-lg d-flex justify-content-between px-lg-5">
        ...
        <ul class="navbar-nav d-flex align-items-center">
            @guest
                <li class="nav-item"><a class="btn btn-primary px-3 font-weight-bold" href="{{ route('login') }}">Login</a></li>
                <li class="nav-item"><a class="btn text-primary px-3 font-weight-bold" href="{{ route('register') }}">Register</a></li>
            @else
